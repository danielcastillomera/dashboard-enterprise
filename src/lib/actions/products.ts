...
export async function createProductServerAction(formData: FormData) {
  ...
  try {
    ...
    await db.createProduct(tenantId, data);
...
export async function updateProductServerAction(id: string, formData: FormData) {
...
export async function deleteProductServerAction(id: string) {
  try {
