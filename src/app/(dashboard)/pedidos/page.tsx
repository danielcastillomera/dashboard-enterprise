...
export default function PedidosPage() {
  ...
  async function handleExportXLSX() { await exportXLSX(orders as unknown as Record<string, unknown>[], exportColumns, `pedidos_${new Date().toISOString().split("T")[0]}`); setShowExportMenu(false); }
